...
expName = 'DMS_etROI_12-36'  # from the Builder filename that created this script
expInfo = {
...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='/Users/richard/Visual_Attention/DMS_etROI_12-36_lastrun.py',
...
ioServer = io.launchHubServer(window=win, experiment_code='DMS_etROI_12-36', session_code=ioSession, datastore_name=filename, **ioConfig)
