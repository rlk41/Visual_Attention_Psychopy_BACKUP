...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='/Users/richard/Visual_Attention/DMS_BEST_eyetracking_DAN_base_12-36_lastrun.py',
...
trials_5 = data.TrialHandler(nReps=trialNum, method='random', 
    extraInfo=expInfo, originPath=-1,
    trialList=data.importConditions("{}/{}-{}.csv".format(dirpath, 4, "PRED")),
...
trials_6 = data.TrialHandler(nReps=trialNum, method='random', 
    extraInfo=expInfo, originPath=-1,
    trialList=data.importConditions("{}/{}-{}.csv".format(dirpath, 5, "UNPRED")),
...
trials_7 = data.TrialHandler(nReps=trialNum, method='random', 
    extraInfo=expInfo, originPath=-1,
    trialList=data.importConditions("{}/{}-{}.csv".format(dirpath, 6, "PRED")),
...
trials_8 = data.TrialHandler(nReps=trialNum, method='random', 
    extraInfo=expInfo, originPath=-1,
    trialList=data.importConditions("{}/{}-{}.csv".format(dirpath, 7, "UNPRED")),
...
for thisTrial_8 in trials_8:
    ...
    # keep track of which components have finished
    trial_8Components = [etRecord_8, sample_8, Response_21, Response_22, Response_23, polygon_8, Delay_8]
...
trials_9 = data.TrialHandler(nReps=trialNum, method='random', 
    extraInfo=expInfo, originPath=-1,
    trialList=data.importConditions("{}/{}-{}.csv".format(dirpath, 8, "PRED")),
...
trials_10 = data.TrialHandler(nReps=trialNum, method='random', 
    extraInfo=expInfo, originPath=-1,
    trialList=data.importConditions("{}/{}-{}.csv".format(dirpath, 9, "UNPRED")),
...
trials_11 = data.TrialHandler(nReps=trialNum, method='random', 
    extraInfo=expInfo, originPath=-1,
    trialList=data.importConditions("{}/{}-{}.csv".format(dirpath, 10, "PRED")),
...
trials_12 = data.TrialHandler(nReps=trialNum, method='random', 
    extraInfo=expInfo, originPath=-1,
    trialList=data.importConditions("{}/{}-{}.csv".format(dirpath, 11, "UNPRED")),
