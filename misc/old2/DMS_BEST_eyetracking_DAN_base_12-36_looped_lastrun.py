...
expName = 'DMS_BEST_eyetracking_DAN_base_12-36_looped'  # from the Builder filename that created this script
expInfo = {
...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='/Users/richard/Visual_Attention/DMS_BEST_eyetracking_DAN_base_12-36_looped_lastrun.py',
...
ioServer = io.launchHubServer(window=win, experiment_code='DMS_BEST_eyetracking_DAN_base_12-36_looped', session_code=ioSession, datastore_name=filename, **ioConfig)
