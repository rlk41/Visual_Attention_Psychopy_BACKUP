...
expName = 'DMS_et_12-36'  # from the Builder filename that created this script
expInfo = {
...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='/Users/richard/Visual_Attention/DMS_et_12-36_lastrun.py',
...
ioServer = io.launchHubServer(window=win, experiment_code='DMS_et_12-36', session_code=ioSession, datastore_name=filename, **ioConfig)
...
for thisBlock in blocks:
    ...
    for thisTrial in trials:
        ...
        # keep track of which components have finished
        trialComponents = [sample, Delay, Response_1, Response_2, Response_3, polygon]
