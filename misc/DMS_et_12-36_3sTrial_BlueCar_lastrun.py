...
expName = 'DMS_et_12-36_3sTrial_BlueCar'  # from the Builder filename that created this script
expInfo = {
...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='/Users/richard/Visual_Attention/DMS_et_12-36_3sTrial_BlueCar_lastrun.py',
...
ioServer = io.launchHubServer(window=win, experiment_code='DMS_et_12-36_3sTrial_BlueCar', session_code=ioSession, datastore_name=filename, **ioConfig)
