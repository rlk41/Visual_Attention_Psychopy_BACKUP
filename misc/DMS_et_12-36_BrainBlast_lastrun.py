...
#        rest_dur=0.2
        ...
        cue_onset=0
        cue_dur=0.2
        delayTime = random.uniform(0.5, .8)   
        delay_resp_period = 1
        rest_dur=0
...
expName = 'DMS_et_12-36_BrainBlast'  # from the Builder filename that created this script
expInfo = {
...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='/Users/richard/Visual_Attention/DMS_et_12-36_BrainBlast_lastrun.py',
...
ioServer = io.launchHubServer(window=win, experiment_code='DMS_et_12-36_BrainBlast', session_code=ioSession, datastore_name=filename, **ioConfig)
    ...
    for thisTrial in trials:
        ...
        while continueRoutine:
            ...
            if etRecord.status == STARTED:
                # is it time to stop? (based on global clock, using actual start)
                if tThisFlipGlobal > etRecord.tStartRefresh + thisTrial['total_dur']-frameTolerance:
                    # keep track of stop time/frame for later
