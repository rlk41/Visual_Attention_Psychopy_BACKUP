...
try: 
    ...
    _thisDir = "/Users/kleinrl/Visual_Attention"
    
os.chdir(_thisDir)
# Store info about the experiment session
psychopyVersion = '2022.2.4'
expName = 'DMS_v3'  # from the Builder filename that created this script
expInfo = {
...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='/Users/kleinrl/Visual_Attention/DMS_v3.py',
...
# --- Initialize components for Routine "wait4calib" ---
key_resp = keyboard.Keyboard()
text = visual.TextStim(win=win, name='text',
    text='Press "t" to continue to calibration',
    font='Open Sans',
...
# --- Prepare to start Routine "wait4calib" ---
...
wait4calibComponents = [key_resp, text]
for thisComponent in wait4calibComponents:
...
thisExp.nextEntry()
# the Routine "wait4calib" was not non-slip safe, so reset the non-slip timer
routineTimer.reset()
