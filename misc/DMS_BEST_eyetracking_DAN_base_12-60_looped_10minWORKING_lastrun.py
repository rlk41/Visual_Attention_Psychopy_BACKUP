...
trialNum = 15 # 9 trials * 4sec/trial = 36 sec + 12 sec baseline
#trialNum = 50 # long 
#trialNum = 5 # long - 50 
...
expName = 'DMS_BEST_eyetracking_DAN_base_12-60_looped_10minWORKING'  # from the Builder filename that created this script
expInfo = {
...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='/Users/richard/Visual_Attention/DMS_BEST_eyetracking_DAN_base_12-60_looped_10minWORKING_lastrun.py',
...
ioServer = io.launchHubServer(window=win, experiment_code='DMS_BEST_eyetracking_DAN_base_12-60_looped_10minWORKING', session_code=ioSession, datastore_name=filename, **ioConfig)
...
for i_block in range(len(blockTypes)): 
    ...
    outfile = "{}/{}-{}_12-60.csv".format(dirpath, i_block, blockType)
    df.to_csv(outfile)
