...
#        cue_dur=1
        ...
        resp_dur=delay_response_total_time - delayTime
...
#        rest_dur=0.5
        ...
        print("total time: {}".format(cross_onset+cross_dur))
...
expName = 'DMS_et_12-36_3sTrial_BlueCar_pseudoRandPRED'  # from the Builder filename that created this script
expInfo = {
...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='/Users/richard/Visual_Attention/DMS_et_12-36_3sTrial_BlueCar_pseudoRandPRED_lastrun.py',
...
ioServer = io.launchHubServer(window=win, experiment_code='DMS_et_12-36_3sTrial_BlueCar_pseudoRandPRED', session_code=ioSession, datastore_name=filename, **ioConfig)
